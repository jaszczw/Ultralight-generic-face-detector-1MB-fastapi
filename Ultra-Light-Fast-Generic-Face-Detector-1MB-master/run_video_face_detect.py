...
label_path = "./Ultra-Light-Fast-Generic-Face-Detector-1MB-master/models/voc-model-labels.txt"
...
if net_type == 'slim':
    model_path = "Ultra-Light-Fast-Generic-Face-Detector-1MB-master/models/pretrained/version-slim-320.pth"
    # model_path = "models/pretrained/version-slim-640.pth"
    net = create_mb_tiny_fd(len(class_names), is_test=True, device=test_device)
    predictor = create_mb_tiny_fd_predictor(net, candidate_size=candidate_size, device=test_device)
elif net_type == 'RFB':
    model_path = "Ultra-Light-Fast-Generic-Face-Detector-1MB-master/models/pretrained/version-RFB-320.pth"
